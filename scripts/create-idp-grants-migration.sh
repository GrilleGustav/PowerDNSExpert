...
dotnet ef migrations add "${MIGRATION_NAME}" \
  ...
  --output-dir Migrations/IdentityServer/PersistedGrants

echo "Migration '${MIGRATION_NAME}' created in src/IdentityProvider/Migrations/IdentityServer/PersistedGrants"
